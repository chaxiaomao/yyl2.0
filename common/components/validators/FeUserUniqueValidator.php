...
class FeUserUniqueValidator extends Validator {
     ...
     */
    protected function getTargetClass($model) {
     ...
     */
    protected function modelExists($targetClass, $conditions, $model) {
     ...
     */
    protected function prepareQuery($targetClass, $conditions) {
     ...
     */
    protected function prepareConditions($targetAttribute, $model, $attribute) {
     ...
     */
    protected function addComboNotUniqueError($model, $attribute) {
        $attributeCombo = [];
        $valueCombo = [];
     ...
     * @return array
     */
    protected function applyTableAlias($query, $conditions, $alias = null) {
        if ($alias === null) {
