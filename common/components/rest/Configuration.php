...
class Configuration extends Component {
     ...
     *
     * @var common\components\rest\ApiClient
     */
    ...
    public function setParams($items) {
        if (isset($items['host'])) {
            $this->setHost($items['host']);
        } else {
            throw new \yii\base\InvalidParamException(Yii::t('app.c2', 'Invalid Parameter {s1}', ['s1' => 'host']));
        }
        if (isset($items['clientId'])) {
            $this->setClientId($items['clientId']);
        } else {
            throw new \yii\base\InvalidParamException(Yii::t('app.c2', 'Invalid Parameter {s1}', ['s1' => 'clientId']));
        }
        if (isset($items['clientSecret'])) {
            $this->setClientSecret($items['clientSecret']);
        } else {
            throw new \yii\base\InvalidParamException(Yii::t('app.c2', 'Invalid Parameter {s1}', ['s1' => 'clientSecret']));
        }
    }
