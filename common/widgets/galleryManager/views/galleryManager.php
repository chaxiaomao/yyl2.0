...
<?php
echo Html::a('<i class="glyphicon glyphicon-plus"></i>', ['edit?pid='.Yii::$app->request->get('pid')], [
        'class' => 'btn btn-success',
        'title' => Yii::t('app.c2', 'Add'),
        'data-pjax' => '0',
    ]) . ' ' .
    Html::a('<i class="glyphicon glyphicon-repeat"></i>', \yii\helpers\Url::current(), [
