...
namespace common\widgets\Y2sp;

use common\widgets\Y2sp\assets\InfiniteAjaxScrollAsset;
use Yii;
...
class ScrollPager extends Widget
{
    ...
    public $prevTriggerTemplate = '<div class="ias-trigger" style="text-align: center; cursor: pointer;"><a>{text}</a></div>';
    ...
    public function init()
    {
        ...
        Yii::$app->i18n->translations = ArrayHelper::merge(Yii::$app->i18n->translations, [
            'Y2sp' => [
                ...
                'basePath' => '@common/widgets/Y2sp/messages',
                'fileMap' => [
                    'Y2sp' => 'general.php'
                ]
            ]
        ...
        if ($this->triggerText === null) {
            $this->triggerText = Yii::t('Y2sp', 'Load more items');
        }

        // Set default "none left" message text if not set
        if ($this->noneLeftText === null) {
            $this->noneLeftText = Yii::t('Y2sp', 'You reached the end');
        }
    }
        ...
        $this->registerExtensions([
            ...
            [
                ...
                'options' => [
                    ...
                    'htmlPrev'=>$this->prevTriggerTemplate,
