        ...
        echo Form::widget([
            ...
            'attributes' => [
                ...
                'activity_id' => [
                    ...
                    'items' => \common\models\c2\entity\ActivityModel::getAllActivities(),
                    'options' => [
                            'placeholder' => $model->getAttributeLabel('activity_id')
                    ]
                ],
                'code' => ['type' => Form::INPUT_TEXT, 'options' => ['placeholder' => $model->getAttributeLabel('code')]],
                'obtain_score' => ['type' => Form::INPUT_TEXT, 'options' => ['placeholder' => $model->getAttributeLabel('obtain_score')]],
                'obtain_vote_number' => ['type' => Form::INPUT_TEXT, 'options' => ['placeholder' => $model->getAttributeLabel('obtain_vote_number')]],
