...
use backend\modules\Sys\modules\Config\widgets\EntityDetail;

/* @var $this yii\web\View */
/* @var $model common\models\c2\entity\Config */

if($model->isNewRecord){
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Create'), 'modelClass' => Yii::t('app.c2', 'Config'),]);
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Configs'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
}
else{
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Update'), 'modelClass' => Yii::t('app.c2', 'Config'),]) . ' ' . $model->id;
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'Configs'), 'url' => ['index']];
...
<?php Pjax::begin(['id' => 'config-pjax', 'enablePushState' => false]) ?>
