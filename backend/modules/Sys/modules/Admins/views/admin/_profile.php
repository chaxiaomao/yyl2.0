...
<?php $this->beginContent('@app/modules/Sys/modules/Admins/views/admin/update.php', ['user' => $user]) ?>
...
$form->field($profile, 'avatar')->widget(FileInput::classname(), [
    ...
    'pluginOptions' => [
        ...
        'browseLabel' => \Yii::t('app.c2', 'Change Avatar'),
        'previewFileType' => 'image',
        'showCaption' => false,
        'showRemove' => false,
        'showUpload' => false,
        'initialPreview' => empty($profile->avatar) ? [] : $profile->getInitialPreview(),
        'initialPreviewConfig' => empty($profile->avatar) ? [] : $profile->getInitialPreviewConfig(),
    ]
])->label(false)
?>
